Consegna
Si realizzi un'applicazione distribuita in C/Unix che, sfruttando la socket API, implementi un servizio di confronto remoto fra stringhe.
...
Per prima cosa, il Client deve inviare al Server la stringhe a cui l'utente è interessato. Il Server deve quindi effettuare il confronto lessicografico tra le stringhe e restituire al client "SI" se le stringhe sono identiche e "NO" in caso contrario. Il Client deve stampare a video il risultato ricevuto dal Server e terminare.
